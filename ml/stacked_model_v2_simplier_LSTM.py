...
# === Параметры ===
SEQUENCE_LENGTH = 120        # Увеличено: 30 часов контекста
MAX_HISTORY = 30000          # Больше данных для обучения
HOLD_CANDLES = 4             # Держим 60 минут
TEST_SIZE = 72               # ~18 часов на валидацию
TARGET_THRESHOLD = 1.003     # +0.3% за 4 свечи

print("🔍 Обучение улучшенной стекинг-модели: LSTM + XGBoost → LightGBM (meta) на 15m")
...
# ✅ Исправление FutureWarning: корректная обработка NaN
...
# Улучшенный таргет: +0.3% за 4 свечи
...
# Сохраняем скалер
joblib.dump(scaler, "./models/scaler_15m.pkl")
...
# === 8. Стекинг: LightGBM как мета-модель ===
